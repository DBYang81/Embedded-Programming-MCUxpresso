...
clean-src:
	-$(RM) ./src/DigitalIoPin.d ./src/DigitalIoPin.o ./src/ITM_write.d ./src/ITM_write.o ./src/Lab2_1.d ./src/Lab2_1.o ./src/PrintItm.d ./src/PrintItm.o ./src/cr_cpp_config.d ./src/cr_cpp_config.o ./src/cr_startup_lpc15xx.d ./src/cr_startup_lpc15xx.o ./src/crp.d ./src/crp.o ./src/sysinit.d ./src/sysinit.o
